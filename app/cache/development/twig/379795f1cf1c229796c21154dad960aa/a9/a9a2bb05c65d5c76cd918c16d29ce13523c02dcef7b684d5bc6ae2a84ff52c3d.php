...
class __TwigTemplate_847d18e22840cd2a00409de36e07bbd03d528ebf7530f5165c7cc9e2964dff59 extends Twig_Template
{
    ...
    {
        $__internal_cf4aac065e1574cc0d866fd42a99c56e0a645d4324c1eeb4f50852f41829addd = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_cf4aac065e1574cc0d866fd42a99c56e0a645d4324c1eeb4f50852f41829addd->enter($__internal_cf4aac065e1574cc0d866fd42a99c56e0a645d4324c1eeb4f50852f41829addd_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@bolt/_buic/_select.twig"));

        
        $__internal_cf4aac065e1574cc0d866fd42a99c56e0a645d4324c1eeb4f50852f41829addd->leave($__internal_cf4aac065e1574cc0d866fd42a99c56e0a645d4324c1eeb4f50852f41829addd_prof);
    ...
    public function getbuic_select($__opt__ = null)
    {
        ...
        ob_start();
        try {
            $__internal_d2bdbadf38835ee5cc52d240070917b18f84776461dc5710ee94a831a92bacbe = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
            $__internal_d2bdbadf38835ee5cc52d240070917b18f84776461dc5710ee94a831a92bacbe->enter($__internal_d2bdbadf38835ee5cc52d240070917b18f84776461dc5710ee94a831a92bacbe_prof = new Twig_Profiler_Profile($this->getTemplateName(), "macro", "buic_select"));
        ...
        ";
            ...
            ";
                // line 42
                if ( !(isset($context["has_empty_val"]) ? $context["has_empty_val"] : $this->getContext($context, "has_empty_val"))) {
                    // line 43
                    echo "                ";
                    $context["options"] = twig_array_merge(array(0 => array("value" => "", "text" => "", "selected" =>  !(isset($context["has_selected_val"]) ? $context["has_selected_val"] : $this->getContext($context, "has_selected_val")))), (isset($context["options"]) ? $context["options"] : $this->getContext($context, "options")));
                    // line 44
                    echo "            ";
                }
                // line 45
...
(isset($context["multiple"]) ? $context["multiple"] : $this->getContext($context, "multiple")), "name" => (($this->getAttribute(            // line 54
...
(isset($context["options"]) ? $context["options"] : $this->getContext($context, "options")), "required" => (($this->getAttribute(            // line 56
...
(isset($context["conf"]) ? $context["conf"] : $this->getContext($context, "conf")), "disabled", array()), "id" => $this->getAttribute(            // line 61
(isset($context["conf"]) ? $context["conf"] : $this->getContext($context, "conf")), "id", array()), "multiple" => $this->getAttribute(            // line 62
(isset($context["conf"]) ? $context["conf"] : $this->getContext($context, "conf")), "multiple", array()), "name" => $this->getAttribute(            // line 63
(isset($context["conf"]) ? $context["conf"] : $this->getContext($context, "conf")), "name", array()), "required" => $this->getAttribute(            // line 64
(isset($context["conf"]) ? $context["conf"] : $this->getContext($context, "conf")), "required", array()));
            // line 66
            echo "
        <div";
            // line 67
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->hclass(array(0 => "buic-select", 1 => $this->getAttribute((isset($context["conf"]) ? $context["conf"] : $this->getContext($context, "conf")), "class", array())));
            ...
            // line 73
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["conf"]) ? $context["conf"] : $this->getContext($context, "conf")), "options", array()));
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                // line 74
                echo "                            ";
                // line 75
                ...
                // line 76
                echo "                            ";
                if (((isset($context["optgroup"]) ? $context["optgroup"] : $this->getContext($context, "optgroup")) != (isset($context["last_optgroup"]) ? $context["last_optgroup"] : $this->getContext($context, "last_optgroup")))) {
                    // line 77
                    echo "                                ";
                    if (((isset($context["last_optgroup"]) ? $context["last_optgroup"] : $this->getContext($context, "last_optgroup")) != false)) {
                        // line 78
                        echo "                                    </optgroup>
                                ";
                    }
                    // line 80
                    echo "                                ";
                    if (((isset($context["optgroup"]) ? $context["optgroup"] : $this->getContext($context, "optgroup")) != false)) {
                        // line 81
                        echo "                                    <optgroup label=\"";
                        echo twig_escape_filter($this->env, (isset($context["optgroup"]) ? $context["optgroup"] : $this->getContext($context, "optgroup")), "html", null, true);
                        echo "\">
                                ";
                    }
                    // line 83
                    echo "                                ";
                    $context["last_optgroup"] = (isset($context["optgroup"]) ? $context["optgroup"] : $this->getContext($context, "optgroup"));
                    // line 84
                    echo "                            ";
                }
                // line 85
...
$context["option"], "value", array()) == "") && ((isset($context["opttext"]) ? $context["opttext"] : $this->getContext($context, "opttext")) == ""))) ? ("–") : (false)));
                // line 93
                echo "                            <option";
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->hattr((isset($context["optattr"]) ? $context["optattr"] : $this->getContext($context, "optattr")));
                echo ">";
                echo twig_escape_filter($this->env, (isset($context["opttext"]) ? $context["opttext"] : $this->getContext($context, "opttext")), "html", null, true);
                echo "</option>
                        ";
            }
            $_parent = $context['_parent'];
            ...
            echo "
                ...
                ";
            // line 103
            if (($this->getAttribute((isset($context["conf"]) ? $context["conf"] : $this->getContext($context, "conf")), "clear", array()) || $this->getAttribute((isset($context["conf"]) ? $context["conf"] : $this->getContext($context, "conf")), "all", array()))) {
                // line 104
                echo "                    <div>
                        ";
                // line 105
                if ($this->getAttribute((isset($context["conf"]) ? $context["conf"] : $this->getContext($context, "conf")), "clear", array())) {
                    // line 106
                ...
                // line 110
                echo "                        ";
                if ($this->getAttribute((isset($context["conf"]) ? $context["conf"] : $this->getContext($context, "conf")), "all", array())) {
                    // line 111
    ...
    ";
            ...
            $__internal_d2bdbadf38835ee5cc52d240070917b18f84776461dc5710ee94a831a92bacbe->leave($__internal_d2bdbadf38835ee5cc52d240070917b18f84776461dc5710ee94a831a92bacbe_prof);
...
{% macro buic_select(opt) %}
    ...
    {% endspaceless %}
{% endmacro %}
", "@bolt/_buic/_select.twig", "app://view/twig/_buic/_select.twig");
    }
}
